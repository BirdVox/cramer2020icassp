...
import localmodule
from models import create_hierarchical_containment_model
...
print("Training hierarchical containment (coarse-to-fine) multi-label convnet on " + train_dataset_name)
print("")
...
inputs, outputs \
    = create_hierarchical_containment_model(n_input_hops, n_filters, n_hidden_units, kernel_size, pool_size, base_wd=base_wd)
...
model_name = "classify-hierarchical-containment-coarsetofine-multilabel-var01"
...
losses = {
    ...
    "y_medium": localmodule.multilabel_bce,
    "y_fine": localmodule.multilabel_bce,
}
