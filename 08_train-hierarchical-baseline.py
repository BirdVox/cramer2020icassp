...
import localmodule
from models import create_hierarchical_baseline_model
...
print("Training hierarchical (coarse-to-fine) convnet on " + train_dataset_name)
print("")
...
inputs, outputs \
    = create_hierarchical_baseline_model(n_input_hops, n_filters, n_hidden_units, kernel_size, pool_size, base_wd=base_wd)
...
model_name = "classify-hierarchical-coarsetofine-convnet"
