...
import localmodule
from models import create_taxonet_model
...
print("Training hierarchical composition (coarse-to-fine) multi-label convnet on " + train_dataset_name)
print("")
...
inputs, outputs \
    = create_taxonet_model(n_input_hops, n_filters, n_hidden_units, kernel_size, pool_size, base_wd=base_wd)
...
model_name = "classify-hierarchical-composition-coarsetofine-multilabel-convnet"
